...
class Store(models.Model):
    ...
    collection_title = models.CharField(default="", max_length=255, verbose_name="collection_title")
    collection_description = models.CharField(default="", max_length=255, verbose_name="collection_description")
    product_title = models.CharField(default="", max_length=255, verbose_name="product_title")
    product_description = models.CharField(default="", max_length=255, verbose_name="product_description")
