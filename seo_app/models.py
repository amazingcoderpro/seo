...
class Store(models.Model):
    ...
    collection_title = models.CharField(blank=True, null=True, max_length=255, verbose_name="collection_title")
    collection_description = models.CharField(blank=True, null=True, max_length=255, verbose_name="collection_description")
    product_title = models.CharField(blank=True, null=True, max_length=255, verbose_name="product_title")
    product_description = models.CharField(blank=True, null=True, max_length=255, verbose_name="product_description")
...
class Product(models.Model):
    ...
    title = models.TextField(blank=True, null=True, verbose_name="产品title")
    ...
    meta_title = models.TextField(blank=True, null=True, verbose_name="产品meta_title")
