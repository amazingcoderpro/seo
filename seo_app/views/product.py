...
class ProductMotifyViews(generics.CreateAPIView):
    ...
    def create(self, request, *args, **kwargs):
        ...
        models.Product.objects.filter(id__in=eval(product_list)).update(title=request.data["title"], description=request.data["description"], remark_title=request.data["remark_title"],remark_description=request.data["remark_description"], update_time=datetime.datetime.now(), state=-1)
